        ...
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
            ...
            <header style={{ marginBottom: 48, display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end' }}>
                ...
                <div style={{ display: 'flex', gap: 12 }}>
                    <button className="btn btn-secondary" style={{ borderRadius: 16 }}>
                        <Users size={18} /> Active Delegates
                    </button>
                    <button className="btn btn-primary" style={{ borderRadius: 16, gap: 8 }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 20, marginBottom: 40 }}>
                {[
                    ...
                    { label: 'Active Epoch', value: '742', icon: <RefreshCw size={16} />, color: 'var(--info)' },
                    { label: 'Quorum Reached', value: '100%', icon: <Target size={16} />, color: 'var(--success)' },
                    { label: 'Network Pulse', value: 'Steady', icon: <Activity size={16} />, color: 'var(--secondary)' }
                ].map((stat, i) => (
                            ...
                            <motion.div key={id} whileHover={{ y: -4 }} style={cardBg}>
                                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 16 }}>
                                    ...
                                    <div style={{ textAlign: 'right' }}>
                                        ...
                                        <div style={{ fontSize: '1rem', fontWeight: 900 }}>14,250</div>
                                    </div>
                                </div>
                                <div style={{ height: 6, width: '100%', background: 'rgba(255,255,255,0.03)', borderRadius: 10, overflow: 'hidden', marginBottom: 24 }}>
                                    <div style={{ width: '68%', height: '100%', background: 'var(--accent-light)' }} />
                                </div>
                                <div style={{ display: 'flex', gap: 12 }}>
                                    <button className="btn btn-primary" style={{ flex: 1, height: 44, borderRadius: 12 }}>Vote Support</button>
                                    <button className="btn btn-secondary" style={{ flex: 1, height: 44, borderRadius: 12 }}>Vote Oppose</button>
                                </div>
                            </motion.div>
                        ))}
                    </div>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
                    <div style={{ ...cardBg, background: 'linear-gradient(135deg, rgba(34,197,94,0.05), transparent)' }}>
                        <h4 style={{ fontSize: '1rem', fontWeight: 800, marginBottom: 12, display: 'flex', alignItems: 'center', gap: 8 }}>
                            <TrendingUp size={18} color="var(--success)" /> Treasury Health
                        </h4>
                        <div style={{ fontSize: '1.8rem', fontWeight: 900, marginBottom: 4 }}>$4,240,000</div>
                        <p style={{ fontSize: '0.75rem', opacity: 0.5 }}>Accumulated protocol fees for community distribution.</p>
                    </div>
                    ...
                    <div style={cardBg}>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                            {[
                                { label: 'Voter Turnout', val: '68%', desc: '14,200 unique wallets' },
