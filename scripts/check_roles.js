import { createPublicClient, http, hexToBytes, keccak256, stringToBytes } from 'viem';
...
async function checkRoles() {
  ...
  console.log('Admin Role:', results[0] ? '✅' : '❌');
  console.log('Manager Role:', results[1] ? '✅' : '❌');
  console.log('Arbitrator Role:', results[2] ? '✅' : '❌');
}
