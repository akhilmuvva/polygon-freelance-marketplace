...
export class SovereignRegistry extends ethereum.SmartContract {
  static bind(address: Address): SovereignRegistry {
    return new SovereignRegistry("SovereignRegistry", address);
  }
